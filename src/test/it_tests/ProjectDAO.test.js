...
describe('Test Project DAO', () => {
  ...
  test('it_should_change_name_of_a_project', async () =>{
    let userTest;
    await userDAO.getUserByName('user', (user) =>{
      userTest = user
    });
    ...
    let editedProject;
    projectDAO.save(projects[0], function(project) {
