...
|Tc5i | (Design Tc5d) Implémenter la classe USDAO.js en suivant le fichier SpecApp.md | 8, 11 | Tc5d | 0.5 | | TODO |
|Tc8d | Spécifier l'objet US qui permet d'utiliser le DAO USDAO.js dans le fichier SpecApp.md  | 8,11 | (Tc5d) | 0.5 | | TODO |
|Tc8i | (Design Tc8d) Implémenter la classe US.js en suivant le fichier SpecAdd.md | 8,11 | | 0.5 | | TODO |
...
|Tc23i | (Design Tc23d :) En se basant sur le fichier SpecFront.md : Créer un fichier Backlog.html. Ce fichier listera les informations des US présents en base de donnée lié à ce projet. Ces informations seront affichées dans des rectangles les un en dessous des autres. | 8 | Tc23d  | 0.5 | | TODO |
|Tc24d |Spécifier le contenu de la page AddUS.html qui doit être un formulaire permettant l'ajout d'une nouvelle US au backlog du projet dans le fichier SpecFront.md | 11 |  | 0.5 | | TODO |
